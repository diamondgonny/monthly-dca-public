...
def get_portfolio_from_google_sheet_1(worksheet: Worksheet, row_base_pointer: int, row_stack_pointer: int):
...
def get_portfolio_from_google_sheet_2(worksheet: Worksheet, row_base_pointer: int, row_stack_pointer: int, **portfolio_input):
    row_pointer = row_base_pointer
    print("Loading...")
